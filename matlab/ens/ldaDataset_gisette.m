subspaces=[2 5 10 20 50 100 200 500 1000];
...
[fig myAxes]=createAxes([3 3],'title',sTitle,'hSize',8.5,'vSize',11.5,'leftOffset',0,'legendHeight',0.75,'vMargin',1.25);
...
[fig myAxes]=createAxes([3 3],'title',sTitle,'hSize',7.5,'vSize',8.5,'leftOffset',0,'legendHeight',0.8,'vMargin',1.25);
