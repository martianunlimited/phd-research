...
% This file ensembles the results using simple majority vote for ResNet-50
...
top1r50=reshape(sum(records(:,1,:,:),2),50,ensSize,noSubspace);
top3r50=reshape(sum(records(:,1:3,:,:),2),50,ensSize,noSubspace);
top5r50=reshape(sum(records(:,1:5,:,:),2),50,ensSize,noSubspace);

meanT1r50=(mean(top1r50,1)/49999 * 100)
meanT3r50=(mean(top3r50,1)/49999 * 100)
meanT5r50=(mean(top5r50,1)/49999 * 100)

stdT1r50=std(top1r50,1)/49999 * 100
stdT3r50=std(top3r50,1)/49999 * 100
stdT5r50=std(top5r50,1)/49999 * 100
