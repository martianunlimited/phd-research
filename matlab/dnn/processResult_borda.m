...
% This file ensembles the results using Borda Counts
...
best2=sparse([1:50000],results(:,2),ones(50000,1));
best=best+best2;
best2=sparse([1:50000],results(:,4),ones(50000,1)*.8);
best=best+best2;
best2=sparse([1:50000],results(:,6),ones(50000,1)*.6);
best=best+best2;
best2=sparse([1:50000],results(:,8),ones(50000,1)*.4);
best=best+best2;
best2=sparse([1:50000],results(:,10),ones(50000,1)*.2);
best=best+best2;
