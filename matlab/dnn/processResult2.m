...
% This file ensembles the results using weighted majority vote (not used)
...
filename=sprintf('resnet501/run_%d/result_%d.mat',directory,subspace);
...
tempRecord;
records(:,counter)=tempRecord;
records2(1,counter)=top1;
records2(2,counter)=top2;
records2(3,counter)=top3;
records2(4,counter)=top4;
records2(5,counter)=top5;
records2(6,counter)=top6;
tempRecord(1)/49999
