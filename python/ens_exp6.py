...
tensorboard=TensorBoard(log_dir='/media/jsl18/Lexar/exp6', histogram_freq=1, write_graph=True, write_images=False)
...
out=Dense(nb_classes,bias_initializer='zeros', activation='softmax')(concatL)
...
history=model.fit_generator(myGeneratorTrain(), steps_per_epoch = 400 , epochs = 2000, verbose=2, validation_data=([sumXval/ensSize, maxXval, minXval],Y_val),callbacks=[tensorboard] )
