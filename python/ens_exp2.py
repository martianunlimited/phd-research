...
tensorboard=TensorBoard(log_dir='./exp2', histogram_freq=1, write_graph=True, write_images=False)
...
layer1=Dense(nb_hidden,bias_initializer='zeros', kernel_regularizer=regularizers.l1(0.00001), activation='relu')(concatL)
out=Dense(nb_classes,bias_initializer='zeros',kernel_regularizer=regularizers.l1(0.00001),  kernel_initializer='identity', activation='softmax')(layer1)
