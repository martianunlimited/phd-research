...
res50Dir=np.arange(23)+1;
res152Dir=np.arange(24)+1;
...
print(minL)
print(maxL)
np.savez('nnStats4.npz',meanL=meanL,stdL=stdL,medL=medL,minL=minL,maxL=maxL,ensL=ensL,subspaceL=subspaceL)
scio.savemat('nnStats4.mat',{'meanL':meanL,'stdL':stdL,'medL':medL,'minL':minL,'maxL':maxL,'ensL':ensL,'subspaceL':subspaceL})
