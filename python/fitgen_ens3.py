...
layer1=Dense(nb_hidden,kernel_regularizer=regularizers.l1(0.000001),bias_initializer='zeros', activation='relu')(concatL)
#layer1=Dropout(0.5)(layer1)
out=Dense(nb_classes,kernel_regularizer=regularizers.l1(0.000001),bias_initializer='zeros', kernel_initializer='identity',activation='softmax')(layer1)
...
model.fit_generator(myGeneratorTrain(), steps_per_epoch = 400 , epochs = 200, verbose=2, validation_data=myGeneratorVal(), validation_steps=100 )
