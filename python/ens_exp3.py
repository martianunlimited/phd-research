...
layer1=Dense(nb_hidden,bias_initializer='zeros', kernel_initializer='identity', kernel_regularizer=regularizers.l1(0.00001), activation='relu')(concatL)
out=Dense(nb_classes,bias_initializer='zeros',kernel_regularizer=regularizers.l1(0.000001), activation='softmax')(layer1)
